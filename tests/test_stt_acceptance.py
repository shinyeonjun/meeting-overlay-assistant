...
from backend.app.services.audio.stt.benchmarking import (
...
def test_faster_whisper_실제_wav에서_기준_정확도_이하로_유지된다():
    wav_path = Path("D:/caps/tests/video/test_16k_mono_15s.wav")
    reference_path = Path("D:/caps/tests/video/test.txt")
