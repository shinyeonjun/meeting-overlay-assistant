...
from backend.app.services.audio.stt import speech_to_text_factory as factory_module
...
from backend.app.services.audio.stt.speech_to_text_factory import create_speech_to_text_service
