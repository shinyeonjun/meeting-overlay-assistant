...
from backend.app.services.diarization.pyannote_speaker_diarizer import PyannoteSpeakerDiarizer
from backend.app.services.diarization.pyannote_worker_speaker_diarizer import (
...
from backend.app.services.diarization.unknown_speaker_diarizer import UnknownSpeakerDiarizer
...
class TestSpeakerDiarizerFactory:
    ...
    def test_pyannote_worker_backend를_선택하면_worker_분리기를_반환한다(self):
        diarizer = create_speaker_diarizer(
            ...
            worker_script_path="D:/caps/backend/scripts/pyannote_worker.py",
        )
