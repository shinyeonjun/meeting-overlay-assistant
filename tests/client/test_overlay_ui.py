...
class TestOverlayUi:
    ...
    def test_tauri_dev_url과_overlay_index가_정상이다(self):
        ...
        assert 'data-tab="report"' in index_content
        assert 'id="report-format-select"' in index_content
        assert 'id="generate-report-btn"' in index_content
        assert 'id="history-refresh-btn"' in index_content
        assert 'id="history-context-summary"' in index_content
        assert 'id="history-context-reset-btn"' in index_content
        assert 'id="history-session-list"' in index_content
        assert 'id="history-report-list"' in index_content
        assert 'id="history-shared-list"' in index_content
        assert 'id="history-timeline-panel"' in index_content
        assert 'id="history-timeline-title"' in index_content
        assert 'id="history-timeline-meta"' in index_content
        assert 'id="history-timeline-list"' in index_content
        assert 'id="history-carry-over-panel"' in index_content
        assert 'id="history-carry-over-decisions"' in index_content
        assert 'id="history-carry-over-actions"' in index_content
        assert 'id="history-carry-over-risks"' in index_content
        assert 'id="history-carry-over-questions"' in index_content
        assert 'id="history-retrieval-panel"' in index_content
        assert 'id="history-retrieval-meta"' in index_content
        assert 'id="history-retrieval-list"' in index_content
        assert 'id="history-preview-body"' in index_content
