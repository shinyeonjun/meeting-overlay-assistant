"""오디오 영역의 test amd whisper npu speech to text service 동작을 검증한다."""
from __future__ import annotations

import numpy as np

import server.app.services.audio.stt.amd_whisper_npu_speech_to_text_service as amd_whisper_module
