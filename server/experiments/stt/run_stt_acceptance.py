...
from server.experiments.stt.benchmark_stt_backends import benchmark_backend, print_summary  # noqa: E402
...
def main() -> None:
    ...
    from server.experiments.stt.benchmark_stt_backends import (
        _BENCHMARK_CONFIG,
