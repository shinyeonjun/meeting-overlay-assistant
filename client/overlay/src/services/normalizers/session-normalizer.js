export function normalizeSessionPayload(payload) {
    return {
        ...
        privacyNoticeAcknowledgedAt: payload.privacy_notice_acknowledged_at ?? null,
        privacyNoticeAcknowledgedBy: payload.privacy_notice_acknowledged_by ?? null,
        privacyNoticeVersion: payload.privacy_notice_version ?? null,
