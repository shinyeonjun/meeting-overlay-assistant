...
function fillSpeaker(element, speakerLabel, fallback = "시스템") {
...
export function renderEventColumn({ container, countElement, template }, items) {
    ...
    for (const item of items) {
        ...
        fillSpeaker(speakerElement, item.speaker_label, "현재 발화");
        stateElement.remove();
...
export function renderManagedEventColumn({ container, countElement, template }, items) {
    ...
    for (const item of items) {
        ...
        fillSpeaker(speakerElement, item.speakerLabel, "현재 발화");
        stateElement.remove();
        titleElement.textContent = item.title;
