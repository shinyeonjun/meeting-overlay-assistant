...
class MeetingEventService:
        ...
        *,
        ...
        for corrected_event in corrected_events:
            ...
            updated_event = replace(
                ...
                priority=corrected_event.priority,
                topic_group=corrected_event.topic_group,
                speaker_label=corrected_event.speaker_label or existing_event.speaker_label,
                assignee=corrected_event.assignee,
                due_date=corrected_event.due_date,
    ...
    def _merge_same_source_event(
        ...
        return replace(
            ...
            topic_group=candidate.topic_group or merged.topic_group,
            assignee=candidate.assignee or merged.assignee,
            due_date=candidate.due_date or merged.due_date,
