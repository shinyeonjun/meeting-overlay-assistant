...
from backend.app.services.audio.stt.transcription import SpeechToTextService
...
def _build_openai_compatible_audio(
    *,
    ...
    from backend.app.services.audio.stt.openai_compatible_audio_transcription_service import (
...
def _build_faster_whisper(
    *,
    ...
    from backend.app.services.audio.stt.faster_whisper_speech_to_text_service import (
        FasterWhisperConfig,
...
def _build_faster_whisper_streaming(
    *,
    ...
    from backend.app.services.audio.stt.faster_whisper_streaming_speech_to_text_service import (
...
def _build_hybrid_local_streaming(
    *,
    ...
    from backend.app.services.audio.stt.hybrid_streaming_speech_to_text_service import (
        HybridStreamingConfig,
        HybridStreamingSpeechToTextService,
    )
    from backend.app.services.audio.stt.transcription import StreamingSpeechToTextService
...
def _build_sherpa_onnx_streaming(
    *,
    ...
    from backend.app.services.audio.stt.sherpa_onnx_streaming_speech_to_text_service import (
...
def _build_moonshine_streaming(
    *,
    ...
    from backend.app.services.audio.stt.moonshine_streaming_speech_to_text_service import (
